...
namespace DatabaseController.Migrations
{
    ...
    [Migration("20230310194231_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatabaseController.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("DatabaseController.Models.Product", b =>
                {
                    b.HasOne("DatabaseController.Models.Availability", "Availability")
                        .WithMany("Products")
                        .HasForeignKey("AvailabilityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DatabaseController.Models.Contraindication", "Contraindication")
                        .WithMany("Products")
                        .HasForeignKey("ContraindicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DatabaseController.Models.Indication", "Indication")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("DatabaseController.Models.User", b =>
                {
                    b.HasOne("DatabaseController.Models.Role", "Role")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("DatabaseController.Models.UserInfo", b =>
                {
                    ...
                    b.HasOne("DatabaseController.Models.User", "User")
                        .WithOne("UserInfo")
                        .HasForeignKey("DatabaseController.Models.UserInfo", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
